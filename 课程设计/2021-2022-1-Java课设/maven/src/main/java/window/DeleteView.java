...
import handler.special.NumberHandler;
...
public class DeleteView extends JDialog {
    ...
    public DeleteView(MainView mainView) {
        ...
        //顶部设置标签
        topLabel = new JLabel("删除收支记录");    //创建顶部标签、设置字体大小
        ...
        //设置左上角
        URL imgLogo = LoginView.class.getClassLoader().getResource("img/deleteLogo.png");
        assert imgLogo != null;
        ...
        //设置背景图片
        imglabel = new JLabel();
        imglabel.setIcon(new ImageIcon(DeleteView.class.getClassLoader().getResource("img/deleteBack.jpg")));

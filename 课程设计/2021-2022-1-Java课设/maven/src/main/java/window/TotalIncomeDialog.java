...
public class TotalIncomeDialog extends JFrame {
    JPanel root = new JPanel(new BorderLayout());

    final JDialog dialog;
    TableDTO tableDTO;
    public TotalIncomeDialog(MainView mainView, Component parentComponent) {
        // 创建一个模态对话框
        dialog = new JDialog(mainView, "收入查询", true);
        // 设置对话框的宽高
        ...
        tableDTO = studentService.totalIncomeStudents(studentRequest);
